<template>
  <!-- Hero Section -->
  <section
    class="pt-4 sm:pt-10 bg-gradient-to-r from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900"
  >
    <div class="container max-w-screen-xl mx-auto pt-5 px-3">
      <div class="text-center">
        ...
        >
          ...
          backend and full-stack development. Proven expertise in designing
          scalable, secure systems and deploying production-grade applications
        ...
        <div
          class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 max-w-2xl mx-auto"
        >
          ...
          <p class="text-gray-600 dark:text-gray-300">
            Leading backend architecture using NestJS, TypeScript, and
            PostgreSQL
          </p>
        </div>
      </div>
  ...
  <section class="py-16 md:py-20 bg-white dark:bg-gray-900">
    <div class="container max-w-screen-xl mx-auto px-4">
      <div class="text-center mb-16">
        <h2
          class="font-bold text-gray-900 dark:text-gray-100 text-4xl md:text-5xl mb-6"
        >
          Professional Experience
        </h2>
        <p
          class="font-normal text-gray-600 dark:text-gray-300 text-lg md:text-xl max-w-2xl mx-auto"
        >
          5+ years of experience building scalable systems and leading
          development teams
        </p>
      </div>
      ...
      <div class="space-y-12">
        <!-- WeGro Global -->
        <div
          class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 shadow-lg"
        >
          <div
          ...
          >
            <div>
              <h3
                class="font-bold text-gray-900 dark:text-gray-100 text-2xl mb-2"
              >
                Senior Backend Engineer
              </h3>
              <h4
                class="font-semibold text-blue-600 dark:text-blue-400 text-xl mb-2"
              >
                WeGro Global Ltd
              </h4>
            ...
            <div class="mt-4 md:mt-0">
              <span
                class="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-4 py-2 rounded-full text-sm font-medium"
              >
                Aug 2024 – Present
              </span>
            </div>
          ...
          <ul class="space-y-3">
            <li class="flex items-start">
              ...
              <span class="text-gray-700 dark:text-gray-300"
                >Lead backend architecture using NestJS (Node.js), TypeScript,
                and PostgreSQL</span
              >
            </li>
            <li class="flex items-start">
              <span class="text-blue-500 mr-3 mt-1">▸</span>
              <span class="text-gray-700 dark:text-gray-300"
                >Deploy production systems on AWS EC2 with Docker, Nginx, and
            ...
            <li class="flex items-start">
              <span class="text-blue-500 mr-3 mt-1">▸</span>
              <span class="text-gray-700 dark:text-gray-300"
                >Optimize database queries and implement system monitoring for
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
          ...
          >
            <div>
              ...
              <h4
                class="font-semibold text-green-800 dark:text-green-400 text-xl mb-2"
              >
                Commerce Connection Ltd (UK)
              </h4>
              <p class="text-gray-600 dark:text-gray-300">
                Onsite / Chobham, United Kingdom
              </p>
            </div>
            <div class="mt-4 md:mt-0">
              <span
          ...
          <ul class="space-y-3">
            <li class="flex items-start">
              ...
              <span class="text-gray-700 dark:text-gray-300"
                >Developed and enhanced full-stack features for enterprise
                clients</span
              >
            </li>
            <li class="flex items-start">
              <span class="text-green-500 mr-3 mt-1">▸</span>
              <span class="text-gray-700 dark:text-gray-300"
                >Supported client-facing consulting on software integration and
                deployment</span
              >
            </li>
          </ul>
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
          ...
          >
            <div>
              ...
              <h4
                class="font-semibold text-purple-600 dark:text-purple-400 text-xl mb-2"
              >
                MNB Technology
              </h4>
              <p class="text-gray-600 dark:text-gray-300">Dhaka, Bangladesh</p>
            ...
            <div class="mt-4 md:mt-0">
              <span
                class="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-4 py-2 rounded-full text-sm font-medium"
              >
                May 2019 – Nov 2022
              </span>
            </div>
          ...
          <ul class="space-y-3">
            <li class="flex items-start">
              ...
              <span class="text-gray-700 dark:text-gray-300"
                >Led backend and data-driven application development using
                Laravel and MySQL</span
              >
            </li>
            <li class="flex items-start">
              <span class="text-purple-500 mr-3 mt-1">▸</span>
              <span class="text-gray-700 dark:text-gray-300"
                >Designed reporting systems and BI dashboards to improve client
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
          ...
          >
            <div>
              ...
              <h4
                class="font-semibold text-orange-600 dark:text-orange-400 text-xl mb-2"
              >
            ...
            <div class="mt-4 md:mt-0">
              <span
                class="bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 px-4 py-2 rounded-full text-sm font-medium"
              >
                Jan 2019 – Apr 2019
              </span>
            </div>
          ...
          <ul class="space-y-3">
            <li class="flex items-start">
              ...
              <span class="text-gray-700 dark:text-gray-300"
                >Built and tested enterprise web applications using Laravel and
                PHP</span
              >
            </li>
            <li class="flex items-start">
              <span class="text-orange-500 mr-3 mt-1">▸</span>
              <span class="text-gray-700 dark:text-gray-300"
                >Collaborated with development team to deliver production-ready
                modules</span
              >
            </li>
          </ul>
  ...
  <!-- Technical Skills -->
  <section
    class="py-16 md:py-20 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900"
  >
    <div class="container max-w-screen-xl mx-auto px-4">
      <div class="text-center mb-16">
        <h2
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          <div class="text-center mb-4">
            ...
            >
              <span class="text-2xl text-green-800 dark:text-green-400"
                >🚀</span
              >
            </div>
            <h3 class="font-bold text-gray-900 dark:text-gray-100 text-xl mb-2">
              Backend
            </h3>
          </div>
          <div class="space-y-2">
        ...
        >
          ...
          <div class="space-y-2">
            <span
              class="inline-block bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-3 py-1 rounded-full text-sm font-medium"
              >PostgreSQL</span
            >
            <span
              class="inline-block bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-3 py-1 rounded-full text-sm font-medium"
        ...
        >
          <div class="text-center mb-4">
            ...
            >
              <span class="text-2xl text-orange-600 dark:text-orange-400"
                >☁️</span
              >
            </div>
            <h3 class="font-bold text-gray-900 dark:text-gray-100 text-xl mb-2">
          ...
          <div class="space-y-2">
            <span
              class="inline-block bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 px-3 py-1 rounded-full text-sm font-medium"
              >AWS</span
            >
            <span
              class="inline-block bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 px-3 py-1 rounded-full text-sm font-medium"
      ...
      <div class="mt-12 bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
        <h3
          class="font-bold text-gray-900 dark:text-gray-100 text-2xl mb-6 text-center"
        >
    ...
    <div class="container max-w-screen-xl mx-auto px-4">
      <div class="text-center mb-16">
        ...
        <p
          class="font-normal text-gray-600 dark:text-gray-300 text-lg md:text-xl max-w-2xl mx-auto"
        >
          Showcase of impactful projects and applications I've built and
          contributed to
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        <!-- WeGro Global -->
        <div
          class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition duration-300"
        >
          ...
          <div class="p-8">
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              Innovative financing solutions for smallholder farmers with NestJS
              backend, dynamic project management, and investment platform
              featuring crowdfunding capabilities.
            </p>
        ...
        >
          ...
          <div class="p-8">
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              Full-stack development for enterprise clients with
              <a
                class="font-medium text-cyan-600 underline dark:text-cyan-500 hover:no-underline"
                href="https://editest.cc-ltd.com/bic-gui/login.html?first=true"
                target="_blank"
                >EDI</a
              >
              solutions, API integrations, and business process automation to
              improve B2B supply chain collaboration and electronic data
              interchange (EDI).
            </p>
            <div class="flex flex-wrap gap-2 mb-6">
              <span
            ...
            <NuxtLink
              ...
              target="_blank"
              class="px-6 py-3 border-2 border-cyan-600 text-cyan-700 rounded-lg hover:bg-cyan-600 hover:text-white transition duration-300 font-semibold"
            >
              Visit Platform
            </NuxtLink>
          </div>
        ...
        >
          ...
          <div class="p-8">
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              Complete e-commerce solution with categories ranging from
              electronics to fashion, featuring advanced product management,
            ...
            <NuxtLink
              ...
              target="_blank"
              class="px-6 py-3 border-2 border-orange-600 text-orange-600 rounded-lg hover:bg-orange-600 hover:text-white transition duration-300 font-semibold"
            >
              Visit Store
            </NuxtLink>
          </div>
        ...
        >
          ...
          <div class="p-8">
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              Comprehensive medical journal platform covering anatomy,
              physiology, pharmacology, and pathology with advanced content
              management and academic publishing features.
            </p>
            <div class="flex flex-wrap gap-2 mb-6">
              <span
                class="bg-teal-100 dark:bg-teal-900 text-teal-800 dark:text-teal-200 px-3 py-1 rounded-full text-sm"
                >Academic</span
              >
              <span
                class="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-3 py-1 rounded-full text-sm"
  ...
  <section class="py-16 md:py-20 bg-white dark:bg-gray-900">
    <div class="container max-w-screen-xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div
          class="text-center p-6 bg-gradient-to-b from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl"
        >
          <div
            class="w-16 h-16 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mx-auto mb-4"
          >
        ...
        <div
          class="text-center p-6 bg-gradient-to-b from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl"
        >
          <div
            class="w-16 h-16 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mx-auto mb-4"
          >
            <span class="text-2xl text-green-800 dark:text-green-400">🧠</span>
          </div>
          <h3 class="font-bold text-gray-900 dark:text-gray-100 text-lg mb-3">
            Problem Solving
          </h3>
          <p class="text-gray-600 dark:text-gray-300 text-sm">
            Strong analytical ability to identify, analyze, and solve complex
            technical challenges
          </p>
        </div>

        <div
          class="text-center p-6 bg-gradient-to-b from-purple-50 to-violet-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl"
        >
          <div
            class="w-16 h-16 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mx-auto mb-4"
          >
          ...
          <p class="text-gray-600 dark:text-gray-300 text-sm">
            Designing robust, scalable system architectures for high-performance
            applications
          </p>
        </div>

        <div
          class="text-center p-6 bg-gradient-to-b from-orange-50 to-amber-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl"
        >
          <div
            class="w-16 h-16 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center mx-auto mb-4"
          >
          ...
          <p class="text-gray-600 dark:text-gray-300 text-sm">
            Effective communication and collaboration with international clients
            and teams
          </p>
        </div>
      </div>
  ...
  <!-- Inspirational Quote -->
  <section
    class="py-16 md:py-20 bg-gradient-to-r from-indigo-600 to-purple-600"
  >
    <div class="container max-w-screen-xl mx-auto px-4">
      <div class="text-center">
        ...
        <p class="text-indigo-100 text-lg md:text-xl">— Robert C. Martin</p>
      </div>
    </div>
  </section>
...
export default {
  setup() {
    useHead({
      ...
      title:
        "MD ASHIKUR RAHMAN | Senior Software Engineer - Backend & Cloud Specialist",
      meta: [
        {
          name: "keywords",
          content:
